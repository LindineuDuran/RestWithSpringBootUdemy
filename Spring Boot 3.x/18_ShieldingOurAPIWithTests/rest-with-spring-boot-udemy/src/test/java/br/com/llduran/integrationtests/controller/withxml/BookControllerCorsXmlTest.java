...
public class BookControllerCorsXmlTest extends AbstractIntegrationTest
{
	...
	{
		BookControllerCorsXmlTest.objectMapper = new ObjectMapper();
		BookControllerCorsXmlTest.objectMapper.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);

		BookControllerCorsXmlTest.book = new BookVO();
	}
	...
	public void testCreate() throws JsonProcessingException
	{
		...
		final var content = given().spec(BookControllerCorsXmlTest.specification)
				.contentType(TestConfigs.CONTENT_TYPE_JSON)
				.header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_ERUDIO)
				.body(BookControllerCorsXmlTest.book)
				.when()
				.post()
				.then()
				.statusCode(200)
		...
		final BookVO persistedBook = BookControllerCorsXmlTest.objectMapper.readValue(content, BookVO.class);
		BookControllerCorsXmlTest.book = persistedBook;
