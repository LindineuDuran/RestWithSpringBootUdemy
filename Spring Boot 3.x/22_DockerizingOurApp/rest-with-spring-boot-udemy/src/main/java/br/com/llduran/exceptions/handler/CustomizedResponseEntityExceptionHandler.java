		...
		extends ResponseEntityExceptionHandler
{
	...
	public final ResponseEntity<ExceptionResponse> handleNotFoundExceptions(final Exception ex, final WebRequest request)
	{
	...
	public final ResponseEntity<ExceptionResponse> handleBadRequestExceptions(final Exception ex, final WebRequest request)
	{
	...
	public final ResponseEntity<ExceptionResponse> handleInvalidJwtAuthenticationExceptions(final Exception ex, final WebRequest request)
	{
		final ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
				request.getDescription(false));
